...
% add supports to customized regressionLayers
supportedNetClasses = {'SeriesNetwork','DAGNetwork'};
supportedRegressionLayerClasses = {'nnet.cnn.layer.RegressionOutputLayer','nnet.layer.RegressionLayer'};
attributes = {'nonempty','nonsparse'};
validateattributes(net, supportedNetClasses, attributes, mfilename, 'net');
validateattributes(net.Layers(end), supportedRegressionLayerClasses, attributes, mfilename, 'net');
